== addon-saphcp
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The addon-saphcp addon enables blah blah...)
...
----
<dependency>
   <groupId>org.jboss.forge.addon.saphcp</groupId>
   <artifactId>addon-saphcp</artifactId>
